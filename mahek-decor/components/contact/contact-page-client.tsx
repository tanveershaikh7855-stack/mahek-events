              ...
              {contactItems.map((item, index) => {
                ...
                return (
                  <motion.a
                    ...
                    className="flex items-center gap-4 p-4 rounded-2xl border border-border bg-white hover:border-forest/30 transition-colors group"
                  >
                    <div className="w-12 h-12 rounded-xl bg-forest-light flex items-center justify-center group-hover:scale-110 transition-transform">
            ...
            <div className="lg:col-span-3">
              {submitted ? (
                <motion.div
                  ...
                  className="p-8 md:p-12 rounded-2xl border border-border bg-white text-center"
                >
                ...
                <motion.form
                  ...
                  className="p-6 md:p-8 rounded-2xl border border-border bg-white space-y-6"
                >
