          ...
          >
            <div className="relative flex-1">
              ...
              <Input
                ...
                className="w-full pl-12 py-3 bg-white/10 border-white/15 text-white placeholder:text-white/40 rounded-xl focus:bg-white/15 focus:border-gold/50 text-sm"
              />
            </div>
            <Button
              type="submit"
              disabled={!email.trim() || status === "loading" || status === "success"}
              className="bg-gold text-ink hover:bg-gold/90 rounded-xl font-semibold h-11 px-6 text-sm"
            >
              {status === "loading" ? (
