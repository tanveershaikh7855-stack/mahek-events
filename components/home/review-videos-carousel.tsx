...
export function ReviewVideosCarousel({
  ...
  // Render if there are videos OR a Google review link to show — so the
  // "Write a Google Review" CTA stays live even before any videos are added.
  if (!hasVideos && !googleReviewUrl) return null;
        ...
        {googleReviewUrl && (
          <div className="mt-8 flex flex-col items-center gap-3 text-center">
            <p className="text-sm text-secondary-text">
              Loved working with us? Your review helps other families find us.
            </p>
            <a
              href={googleReviewUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2.5 rounded-full bg-white border border-black/10 px-6 py-3 text-sm font-semibold text-ink shadow-sm hover:shadow-md hover:border-forest/30 transition-all"
            >
